...
class Observations(object):
	def __init__(self, columns):
		...
		self.observations = {label: [0.0001] for label in columns}
...
def main():
	...
	causal_graph.set_properties(left_mediators_count=1, right_mediators_count=2, forks_count=0, colliders_count=0)
	...
	time.sleep(30)
	print("Running PC")
	run_pc_algorithm(causal_graph=causal_graph, observations=obs.get_observations())
